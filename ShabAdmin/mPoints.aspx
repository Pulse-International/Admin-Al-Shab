        ...
        <main>
            ...
            <div class="navbar-main navbar-expand-lg px-0 mx-4 border-radius-xl bg-white shadow mt-3 mb-1">
                ...
                <dx:ASPxGridView ID="GridPoints" runat="server" DataSourceID="db_Points" KeyFieldName="id" ClientInstanceName="GridPoints" Width="100%" AutoGenerateColumns="False" EnablePagingCallbackAnimation="True" Font-Names="cairo" Font-Size="1em" RightToLeft="True"
                    OnCancelRowEditing="GridPoints_CancelRowEditing" OnRowUpdated="GridPoints_RowUpdated" OnRowDeleting="GridPoints_RowDeleting" OnCellEditorInitialize="GridPoints_CellEditorInitialize">
                    <Settings ShowFilterRow="True" ShowFilterRowMenu="False" ShowHeaderFilterButton="False" AutoFilterCondition="Contains" />

                    <ClientSideEvents BeginCallback="OnGridBeginCallback" RowClick="OnRowClick" RowDblClick="function(s, e) {setTimeout(function(){GridPoints.StartEditRow(MyIndex);},100);}" />
                        ...
                        <dx:GridViewDataTextColumn Caption="" ShowInCustomizationForm="True" Width="100px">
                            ...
                            <DataItemTemplate>
                                <div style="width: 100%; float: left; text-align: center">
                                    <img src="/assets/img/update.png" width="32" height="32" title="تعديل" style="cursor: pointer" onclick="setTimeout(function(){GridPoints.StartEditRow(MyIndex);},100);" />
                                </div>
                            </DataItemTemplate>
                        </dx:GridViewDataTextColumn>
